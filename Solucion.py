...
# =====================================================================
# Reglas de negocio que el LLM debe cruzar semánticamente
...
def obtener_retriever_manual():
    """Crea FAISS solo cuando se realiza una consulta válida."""
    global vectorstore
...
def obtener_llm():
    """Crea el modelo solo cuando una consulta necesita generación."""
    global llm
    if llm is None:
...
def ejecutar_consulta_logistica(pregunta_usuario: str):
    ...
    # Concatenación de los k=2 documentos recuperados para cruce de normas (almacenamiento + despacho)
    contexto_man = (
...
if __name__ == "__main__":
    consultas_ejemplo = [
        ...
        "¿Cómo debe almacenarse y despacharse el ungüento HIPOGLOS?"
    ]
